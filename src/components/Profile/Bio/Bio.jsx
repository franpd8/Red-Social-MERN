    ...
    <div className="userProfile">
      <div className="userProfile__header">
        <img
          ...
          src={header ? header : "https://i.imgur.com/V1nLI5q.jpg"}
        />
      </div>
        ...
        <div className="userButtons">
          {user == userLogId ? (
            <>
              <button
                className="editBtn"
                onClick={() => setEdit((initial) => !initial)}
              >
                Edit profile
              </button>
            </>
              ...
              <div className="userBio">
                ...
                <div className="userStats">
                  <div className="userPosts">
                    <span className="stats"> {userData?.postIds.length}</span>{" "}
                    Posts{" "}
                  </div>
                  <div className="userFollowing">
                    <span className="stats">{userData?.following.length}</span>{" "}
                    Following{" "}
                  </div>

                  <div className="userFollowers">
                    <span className="stats">{userData.followers.length}</span>{" "}
                    Followers{" "}
                  </div>
                </div>
